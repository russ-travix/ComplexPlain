...
{
	public static class WBitmapExtensions
	{
		private const float PreMultiplyFactor = 1 / 255f;

		///// <summary>
		///// Fills the whole WBitmap with a color.
		///// </summary>
		///// <param name="bmp">The WBitmap.</param>
		///// <param name="color">The color used for filling.</param>
		//public static void Clear(this WBitmap bmp, Color color)
		//{
		...
		///// <summary>
		///// Fills the whole WBitmap with an empty color (0).
		///// </summary>
		///// <param name="bmp">The WBitmap.</param>
		//public static void Clear(this WBitmap bmp)
		//{
		...
		public static void DrawLineDDA(this WBitmap bmp, int x1, int y1, int x2, int y2, Color color)
		{
		...
		/// <param name="y2">The y-coordinate of the end point.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawLineDDA(this WBitmap bmp, int x1, int y1, int x2, int y2, int color)
		{
			...
			if (len != 0)
			{
				...
				for (int i = 0; i < len; i++)
				{
					...
					bmp.DrawPixel((int)x, (int)y, color);
					x += incx;
					y += incy;
				}
			}
		...
		/// <param name="y2">The y-coordinate of the end point.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawLine(this WBitmap bmp, int x1, int y1, int x2, int y2, Color color)
		{
		...
		/// <param name="y2">The y-coordinate of the end point.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawLine(this WBitmap bmp, int x1, int y1, int x2, int y2, int color)
		{
			// Use refs for faster access (really important!) speeds up a lot!
			int w = bmp.Bitmap.PixelWidth;
			...
			{ // x increases by +/- 1
				...
				for (int i = 0; i < lenX; i++)
				{
					...
					bmp.DrawPixel(x1, y >> PRECISION_SHIFT, color);
					x1 += incx1;
					y += incy;
				}
			}
			...
			{ // since y increases by +/-1, we can safely add (*h) before the for() loop, since there is no fractional value for y
				...
				{
					bmp.Pixels(index >> PRECISION_SHIFT, color);
					index += inc;
				}
			}
		}
		...
		/// <param name="y2">The y-coordinate of the end point.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawLineBresenham(this WBitmap bmp, int x1, int y1, int x2, int y2, Color color)
		{
			// Distance start and end point
			int dx = x2 - x1;
			int dy = y2 - y1;
		...
		/// <param name="color">The color for the line.</param>
		public static void DrawPolyline(this WBitmap bmp, int[] points, Color color)
		{
		...
		/// <param name="points">The points of the polyline in x and y pairs, therefore the array is interpreted as (x1, y1, x2, y2, ..., xn, yn).</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawPolyline(this WBitmap bmp, int[] points, int color)
		{
			int x1 = points[0];
			int y1 = points[1];
			int x2, y2;
		...
		public static void DrawTriangle(this WBitmap bmp, int x1, int y1, int x2, int y2, int x3, int y3, Color color)
		{
		...
		/// <param name="y3">The y-coordinate of the 3rd point.</param>
		/// <param name="color">The color.</param>
		public static void DrawTriangle(this WBitmap bmp, int x1, int y1, int x2, int y2, int x3, int y3, int color)
		{
			bmp.DrawLine(x1, y1, x2, y2, color);
		...
		/// <param name="color">The color.</param>
		public static void DrawQuad(this WBitmap bmp, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, Color color)
		{
		...
		/// <param name="y4">The y-coordinate of the 4th point.</param>
		/// <param name="color">The color.</param>
		public static void DrawQuad(this WBitmap bmp, int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int color)
		{
			bmp.DrawLine(x1, y1, x2, y2, color);
			bmp.DrawLine(x2, y2, x3, y3, color);
		...
		/// <param name="color">The color.</param>
		public static void DrawRectangle(this WBitmap bmp, int x1, int y1, int x2, int y2, Color color)
		{
		...
		/// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
		/// <param name="color">The color.</param>
		public static void DrawRectangle(this WBitmap bmp, int x1, int y1, int x2, int y2, int color)
		{
			// Use refs for faster access (really important!) speeds up a lot!
			int w = bmp.Bitmap.PixelWidth;
			...
			{
				bmp.Pixels(x, color); // top horizontal line
				bmp.Pixels(offset2, color); // bottom horizontal line
				offset2++;
			}
			...
			{
				bmp.Pixels(y, color); // right vertical line
				bmp.Pixels(endOffset, color); // left vertical line
				endOffset += w;
			}
		}
		...
		/// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawEllipse(this WBitmap bmp, int x1, int y1, int x2, int y2, Color color)
		{
		...
		/// <param name="y2">The y-coordinate of the bounding rectangle's bottom side.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawEllipse(this WBitmap bmp, int x1, int y1, int x2, int y2, int color)
		{
		...
		/// <param name="color">The color for the line.</param>
		public static void DrawEllipseCentered(this WBitmap bmp, int xc, int yc, int xr, int yr, Color color)
		{
		...
		/// <param name="yr">The radius of the ellipse in y-direction.</param>
		/// <param name="color">The color for the line.</param>
		public static void DrawEllipseCentered(this WBitmap bmp, int xc, int yc, int xr, int yr, int color)
		{
			// Use refs for faster access (really important!) speeds up a lot!
			int w = bmp.Bitmap.PixelWidth;
			...
			while (xStopping >= yStopping)
			{
				...
				bmp.Pixels(xc + x + uh, color);  // Quadrant I
				bmp.Pixels(xc - x + uh, color);  // Quadrant II
				bmp.Pixels(xc - x + lh, color);  // Quadrant III
				bmp.Pixels(xc + x + lh, color);  // Quadrant IV
		...
		public static void SetPixeli(this WBitmap bmp, int index, byte r, byte g, byte b)
		{
		...
		/// <param name="g">The green value of the color.</param>
		/// <param name="b">The blue value of the color.</param>
		public static void SetPixel(this WBitmap bmp, int x, int y, byte r, byte g, byte b)
		{
			bmp.Pixels(y * bmp.Bitmap.PixelWidth + x, ( 255 << 24 ) | ( r << 16 ) | ( g << 8 ) | b);
		}
		...
		/// <param name="g">The green value of the color.</param>
		/// <param name="b">The blue value of the color.</param>
		public static void SetPixeli(this WBitmap bmp, int index, byte a, byte r, byte g, byte b)
		{
		...
		/// <param name="g">The green value of the color.</param>
		/// <param name="b">The blue value of the color.</param>
		public static void SetPixel(this WBitmap bmp, int x, int y, byte a, byte r, byte g, byte b)
		{
			float ai = a * PreMultiplyFactor;
			bmp.Pixels(y * bmp.Bitmap.PixelWidth + x, (a << 24) | ((byte)(r * ai) << 16) | ((byte)(g * ai) << 8) | (byte)(b * ai));
		}
		...
		/// <param name="index">The coordinate index.</param>
		/// <param name="color">The color.</param>
		public static void SetPixeli(this WBitmap bmp, int index, Color color)
		{
		...
		/// <param name="y">The y coordinate (column).</param>
		/// <param name="color">The color.</param>
		public static void SetPixel(this WBitmap bmp, int x, int y, Color color)
		{
			float ai = color.A * PreMultiplyFactor;
			bmp.Pixels(y * bmp.Bitmap.PixelWidth + x, (color.A << 24) | ((byte)(color.R * ai) << 16) | ((byte)(color.G * ai) << 8) | (byte)(color.B * ai));
		}
		...
		/// <param name="a">The alpha value of the color.</param>
		/// <param name="color">The color.</param>
		public static void SetPixeli(this WBitmap bmp, int index, byte a, Color color)
		{
			float ai = a * PreMultiplyFactor;
		...
		/// <param name="a">The alpha value of the color.</param>
		/// <param name="color">The color.</param>
		public static void SetPixel(this WBitmap bmp, int x, int y, byte a, Color color)
		{
			float ai = a * PreMultiplyFactor;
			bmp.Pixels(y * bmp.Bitmap.PixelWidth + x, (a << 24) | ((byte)(color.R * ai) << 16) | ((byte)(color.G * ai) << 8) | (byte)(color.B * ai));
		}
		...
		/// <param name="index">The coordinate index.</param>
		/// <param name="color">The color.</param>
		public static void SetPixeli(this WBitmap bmp, int index, int color)
		{
		...
		/// <param name="y">The y coordinate (column).</param>
		/// <param name="color">The color.</param>
		public static void SetPixel(this WBitmap bmp, int x, int y, int color)
		{
			bmp.Pixels(y * bmp.Bitmap.PixelWidth + x, color);
		}
	}
}